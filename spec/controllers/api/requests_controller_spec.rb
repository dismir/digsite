...
describe Api::RequestsController, type: :controller do
  let(:content_type) { :json }
  let(:request_body) { data.to_json }

  subject { post :create, body: request_body, as: content_type }

  describe 'POST create' do
    describe 'to JSON endpoint' do
      context 'as XML' do
    ...
    context 'with valid JSON data' do
      before do
        expect(RequestCreator).to receive(:call)
          .with(permitted_data)
          .and_call_original
      end
